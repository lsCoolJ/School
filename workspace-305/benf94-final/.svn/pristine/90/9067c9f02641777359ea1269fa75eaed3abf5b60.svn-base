...
public class SimulationFrame extends JFrame {
    ...
    /**
     * Used to shorten line.
     */
    private final String myGenMessage = "You must have at"
            + " least 1 human and/or bird to start the simulation.";

    /**
     * This method constructs a new Simulation Frame.
     */
        ...
        myGenerateButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent anE) {
                if (myPeepSlider.getValue() == 0 && myBirdSlider.getValue() == 0) {
                    JOptionPane.showMessageDialog(myWorldPanel, myGenMessage, "Warning!", 2);
                } else {
     ...
     */
    private void setPanelCenter(final WorldPanel aWorldPanel) {
